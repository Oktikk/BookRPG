...
public class Weapon : MonoBehaviour
{
    ...
    bool HigherThanPositiveSlope(Vector2 inputPosition)
    {
    ...
    bool HigherThanNegativeSlope(Vector2 inputPosition)
    {
        Vector2 playerPosition = gameObject.transform.position;
    ...
    {
        bool higherThanPositiveSlopeLine = HigherThanPositiveSlope(Input.mousePosition);

        bool higherThanNegativeSlopeLine = HigherThanNegativeSlope(Input.mousePosition);
